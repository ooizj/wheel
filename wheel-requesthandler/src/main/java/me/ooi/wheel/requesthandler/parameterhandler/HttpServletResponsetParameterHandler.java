 ...
 * @since 1.0
 */
public class HttpServletResponsetParameterHandler implements RequestHandlerParameterHandler {
	...
	public boolean canHandle(MethodParameter methodParameter) {
		...
		return HttpServletResponse.class.isAssignableFrom(paramClass) ; 
	}
